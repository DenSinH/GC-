...
#define PSQ_ST_OPCODE 0xf0000000
GEKKO_INSTR(psq_st);

/* aggregate instructions */
GEKKO_INSTR(instr_000100);

#define PS_MUL_OPCODE_EXTENDED_5bit 0x32
INLINE_GEKKO_INSTR(ps_mul);

#define PS_MSUB_OPCODE_EXTENDED_5bit 0x38
INLINE_GEKKO_INSTR(ps_msub);

#define PS_MADD_OPCODE_EXTENDED_5bit 0x3a
INLINE_GEKKO_INSTR(ps_madd);

#define PS_MADDS0_OPCODE_EXTENDED_5bit 0x1c
INLINE_GEKKO_INSTR(ps_madds0);
#define PS_MADDS1_OPCODE_EXTENDED_5bit 0x1e
INLINE_GEKKO_INSTR(ps_madds1);

#define PS_SUM0_OPCODE_EXTENDED_5bit 0x14
INLINE_GEKKO_INSTR(ps_sum0);
#define PS_SUM1_OPCODE_EXTENDED_5bit 0x16
INLINE_GEKKO_INSTR(ps_sum1);

#define PS_MULS0_OPCODE_EXTENDED_5bit 0x18
INLINE_GEKKO_INSTR(ps_muls0);

#define PS_MULS1_OPCODE_EXTENDED_5bit 0x1a
INLINE_GEKKO_INSTR(ps_muls1);

#define PS_NEG_OPCODE_EXTENDED_10bit 0x050
INLINE_GEKKO_INSTR(ps_neg);

#define PS_MR_OPCODE_EXTENDED_10bit 0x090
INLINE_GEKKO_INSTR(ps_mr);

#define PS_MERGE00_OPCODE_EXTENDED_10bit 0x420
INLINE_GEKKO_INSTR(ps_merge00);
#define PS_MERGE01_OPCODE_EXTENDED_10bit 0x460
INLINE_GEKKO_INSTR(ps_merge01);
#define PS_MERGE10_OPCODE_EXTENDED_10bit 0x4a0
INLINE_GEKKO_INSTR(ps_merge10);
#define PS_MERGE11_OPCODE_EXTENDED_10bit 0x4e0
...
#define ADDME_OPCODE_EXTENDED 0x1d4
...
#define SUBFZE_OPCODE_EXTENDED 0x190
...
#define MULHW_OPCODE_EXTENDED 0x096
INLINE_GEKKO_INSTR(mulhw);

#define MULHWU_OPCODE_EXTENDED 0x016
...
#define EXTSB_OPCODE_EXTENDED 0x774
...
#define STWUX_OPCODE_EXTENDED 0x16e
INLINE_GEKKO_INSTR(stwux);

#define STHX_OPCODE_EXTENDED 0x32e
INLINE_GEKKO_INSTR(sthx);

#define STBX_OPCODE_EXTENDED 0x1ae
INLINE_GEKKO_INSTR(stbx);

#define LWZX_OPCODE_EXTENDED 0x02e
INLINE_GEKKO_INSTR(lwzx);

#define LWZUX_OPCODE_EXTENDED 0x06e
INLINE_GEKKO_INSTR(lwzux);

#define LWBRX_OPCODE_EXTENDED 0x42c
...
#define LFSX_OPCODE_EXTENDED 0x42e
INLINE_GEKKO_INSTR(lfsx);

#define STFSX_OPCODE_EXTENDED 0x52e
...
#define FMSUBS_OPCODE_EXTENDED 0x38
INLINE_GEKKO_INSTR(fmsubs);

#define FMADDS_OPCODE_EXTENDED 0x3a
INLINE_GEKKO_INSTR(fmadds);

#define FNMSUBS_OPCODE_EXTENDED 0x3c
INLINE_GEKKO_INSTR(fnmsubs);

#define FNMADDS_OPCODE_EXTENDED 0x3e
...
#define FRSQRTE_OPCODE_EXTENDED_5bit 0x34
